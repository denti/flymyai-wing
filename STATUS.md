...
- **272 unit tests, 0 failures**, 1.7 s on Linux; the same suite plus 33 macOS-only tests in CI.
...
- **The suite has been proven able to fail, forty-one ways**, and every gate in the
